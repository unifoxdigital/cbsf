			...
			<div role="main" class="main">
				...
				<div class="ccontainer">
					<div class="row" >
						...
						<div class="col-sm-4" style="text-align: center;">
							<a href="shrimp_sea_food.php"><button class="btn" type="button"><span>Shrimp & Other Sea Foods</span></button></a>
						</div>
					</div>
					...
					<li class="col-md-3 col-sm-6 col-xs-12 isotope-item classic">
						<div class="portfolio-item center">
							<a href="baramundi.php" class="text-decoration-none block-link pt-md">
								...
								<h5 class="mb-xs">Barramundi(Koral/Bhetki)</h5>
							</a>
						</div>
					</li>
					<li class="col-md-3 col-sm-6 col-xs-12 isotope-item classic">
						<div class="portfolio-item center">
							<a href="basa.php" class="text-decoration-none block-link pt-md">
								...
								<h5 class="mb-xs">Basa (Catfish)</h5>
							</a>
						</div>
					</li>
					<li class="col-md-3 col-sm-6 col-xs-12 isotope-item classic">
					...
					<li class="col-md-3 col-sm-6 col-xs-12 isotope-item corporate">
						<div class="portfolio-item center">
							<a href="prawan.php" class="text-decoration-none block-link pt-md">
								...
								<h5 class="mb-xs">Prawn(Giant Freshwater)</h5>
							</a>
						</div>
					</li>
					<li class="col-md-3 col-sm-6 col-xs-12 isotope-item corporate">
					...
					<li class="col-md-3 col-sm-6 col-xs-12 isotope-item corporate">
						<div class="portfolio-item center">
							<a href="woallago.php" class="text-decoration-none block-link pt-md">
								...
								<h5 class="mb-xs">Wallago (Boal)</h5>
							</a>
						</div>
					</li>
